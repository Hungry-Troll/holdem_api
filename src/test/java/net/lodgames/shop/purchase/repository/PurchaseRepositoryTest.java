...
public class PurchaseRepositoryTest {
    ...
    @Test
    @Rollback(false)
    public void save_purchase_with_item_then_purchase_saved() {
        ...
        Purchase purchase = purchaseRepository.save(
                Purchase.builder()
                        .purchaseType(PurchaseType.BUY)  // 구매함
                        .userId(1L)                       // 유저 고유번호
    ...
    public void save_purchase_with_bundle_then_purchase_saved() {
        /*Category category = Category.builder()
                .name("카드덱")
                .description("카드덱 카테고리")
                .build();
        ...
        Bundle bundle = bundleRepository.findById(1L).get();

        Purchase purchase = purchaseRepository.save(
                Purchase.builder()
                        .purchaseType(PurchaseType.BUY)    // 구매함
                        .userId(1L)                             // 유저 고유번호
                        .bundleId(bundle.getId())                         // 번들
                        .paidAmount(bundle.getAmount())         // 아이템 가격
