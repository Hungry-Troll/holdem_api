...
public class DiamondService {
    ...
    public void addDiamondByOrder(Long userId, Long quantity, String orderIdempotentKey ) {
        addDiamondWithLock(userId, quantity, DiamondHistoryDesc.DEPOSIT_DIAMOND_BY_ORDER_PAID, orderIdempotentKey);
    }

    public void addDiamondByReceiveStorage(Long userId, Long quantity, String idempotentKey) {
        addDiamondWithLock(userId, quantity, DiamondHistoryDesc.DEPOSIT_DIAMOND_BY_RECEIVE_STORAGE, idempotentKey);
    }
