...
public class RedisConfiguration {
    ...
    @Qualifier("inGameRedisConnectionFactory")
    @Bean(name = "inGameRedisConnectionFactory")
    LettuceConnectionFactory inGameRedisConnectionFactory() {
        return getLettuceConnectionFactory(inGameDatabase);
    }

    @Qualifier("inGameRedisTemplate")
    @Bean(name = "inGameRedisTemplate")
    public RedisTemplate<String, String> inGameRedisTemplate() {
        RedisTemplate<String, String> redisTemplate = new RedisTemplate<>();
        redisTemplate.setConnectionFactory(inGameRedisConnectionFactory());
        redisTemplate.setEnableTransactionSupport(true);
        return redisTemplate;
    }
