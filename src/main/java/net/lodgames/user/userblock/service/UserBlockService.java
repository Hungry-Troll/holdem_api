package net.lodgames.user.userblock.service;
...
import net.lodgames.user.userblock.param.UserBlockDeleteParam;
import net.lodgames.user.userblock.param.UserBlockListParam;
import net.lodgames.user.userblock.param.UserBlockParam;
import net.lodgames.user.userblock.repository.UserBlockQueryRepository;
import net.lodgames.user.userblock.repository.UserBlockRepository;
